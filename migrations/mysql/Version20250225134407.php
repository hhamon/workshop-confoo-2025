...
final class Version20250225134407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agenda_slot (id CHAR(36) NOT NULL, opening_at DATETIME NOT NULL, closing_at DATETIME NOT NULL, status LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, agenda_id CHAR(36) NOT NULL, INDEX IDX_912B8217EA67784A (agenda_id), UNIQUE INDEX agenda_slot_window_unique (agenda_id, opening_at, closing_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE health_specialist (id CHAR(36) NOT NULL, first_name LONGTEXT NOT NULL, last_name LONGTEXT NOT NULL, specialty LONGTEXT NOT NULL, introduction LONGTEXT DEFAULT NULL, biography LONGTEXT DEFAULT NULL, profile_picture_url LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE medical_appointment (id CHAR(36) NOT NULL, opening_at DATETIME NOT NULL, closing_at DATETIME NOT NULL, reference_number LONGTEXT NOT NULL, first_name LONGTEXT NOT NULL, folded_first_name LONGTEXT NOT NULL, last_name LONGTEXT NOT NULL, folded_last_name LONGTEXT NOT NULL, email LONGTEXT NOT NULL, phone LONGTEXT NOT NULL, created_at DATETIME NOT NULL, cancelled_at DATETIME DEFAULT NULL, cancellation_reason LONGTEXT DEFAULT NULL, practitioner_id CHAR(36) NOT NULL, INDEX IDX_6CC137F61121EA2C (practitioner_id), UNIQUE INDEX medical_appointment_reference_number_unique (reference_number), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
